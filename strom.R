...
Before the analysis, the data need some preprocessing. Event types don’t have a specific format. For instance, there are events with types  Frost/Freeze, FROST/FREEZE and FROST\\FREEZE which refer to the same type of event. So we will translate all letters to lowercase for uniformity.
